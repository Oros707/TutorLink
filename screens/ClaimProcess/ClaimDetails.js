  ...
  return (
    <ScrollView style={styles.container}>
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : null}>
        ...
        <TextInput style={styles.input} placeholder="Enter Identity/Passport No." value={identity} onChangeText={setIdentity} />
        ...
        <TextInput style={styles.input} placeholder="Enter Home Address" value={address} onChangeText={setAddress} />

        <Text style={styles.inputLabel}>Email Address</Text>
        <TextInput style={styles.input} placeholder="Enter Email Address" value={email} onChangeText={setEmail} />

        <Text style={styles.inputLabel}>Cellphone Number</Text>
        <TextInput style={styles.input} placeholder="Enter Cellphone Number" value={phonenumber} onChangeText={setPhoneNumber} />

        <Text style={styles.inputLabel}>Disability</Text>
        <TextInput style={styles.input} placeholder="IF YES, STATE NATURE" value={disability} onChangeText={setDisability} />
        ...
        <TextInput style={styles.input} placeholder="Enter Contract E/T No." value={contractETNo} />
